    ...
    // Admin routes
    {
        ...
        children: [
            ...
            },
            {
                path: 'income',
                loadChildren: () =>
                    import('app/modules/admin/income/income.module').then(
                        (m) => m.IncomeModule
                    ),
            },
            {
                path: 'expense',
                loadChildren: () =>
                    import('./modules/admin/expense/expense.module').then(
                        (m) => m.ExpenseModule
                    ),
            },
            {
                path: 'accounts',
                loadChildren: () =>
                    import('./modules/admin/accounts/accounts.module').then(
                        (m) => m.AccountsModule
                    ),
            },
            {
                path: 'tax',
                loadChildren: () =>
                    import('./modules/admin/tax/tax.module').then(
                        (m) => m.TaxModule
                    ),
            },
            {
